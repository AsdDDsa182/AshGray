(function(){
  ...
  let scrollYPos = 0; // 현재 스크롤 위치를 저장할 변수
  ...
  function showOverlay(){ lockScroll(); overlay.hidden=false; }
  function hideOverlay(){ unlockScroll(); overlay.hidden=true; }
