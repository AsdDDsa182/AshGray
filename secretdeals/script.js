(function(){
  ...
  /* ===== 설정 ===== */
  const SECRET_PASSWORD = '1'; // ✅ 비밀번호 설정
  ...
  const PRODUCTS = [
    ...
    { id:'dumbbell-set', title:'GOFIT 육각 덤벨 세트', image:'https://images.unsplash.com/photo-15847ท5935682-2f2b69dff9d2?q=80&w=1200&auto=format&fit=crop', original:990000, sale:750000, link:STORE_URL, nshop:'#' },
